...
export declare class RelayAdaptV2Contract {
    ...
    populateUnshieldBaseToken(transactions: TransactionStructV2[], unshieldAddress: string, random31Bytes: string, useDummyProof: boolean): Promise<ContractTransaction>;
    /**
     * @returns Populated transaction
     */
